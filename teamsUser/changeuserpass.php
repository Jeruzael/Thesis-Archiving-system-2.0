          ...
          <div class="container-fluid pt-5">
               <div class="row align-items-center p-5 loginRow">
                    <div class="col">
                         ...
                         <form  action="changeuserpass.php" method="post" class="loginForm">
                              <label class="alert alert-info" role="alert">Note: Please Remember your new Student Password</label>
                              ...
                              <input name="changeuserpass" type="submit" class="btn form-control submitBtn" value="CHANGE AND LOGIN"/>
                         </form>
                    </div>
               </div>
          </div>
