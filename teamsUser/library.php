                    ...
                    <div class="card-body" style="max-height: 100px; min-height: 100px; overflow:auto;">
                         <h5 class="card-title" style="font-size:11pt;">                               
                             <!--  <label style="color:#FD8978;">Thesis Title</label> -->
                              ...
                              <p><i class='bx bx-book' style="font-size: 10pt; color: #7788F4;"></i>
                                <span> </span><?php echo ucwords($row['bookTitle']); ?></p>
                                   <p><i class='bx bx-calendar' style="font-size: 10pt; color: #7788F4;"></i>
                                <span> </span><?php echo $row['publish']; ?></p>
