...
<html lang="en">
     <head>
          ...
          <title>Student - Recover Account</title>
          <title>Administration - Recover Account</title>
          ...
          <div class="container-fluid pt-5">
               <div class="row align-items-center p-5 loginRow">
                    <div class="col">
                         ...
                         <h5>STUDENT EMAIL VERIFICATION</h5>
                         <h6 class="mb-4">Thesis Archiving System</h6>
                         <form  action="verify.php" method="post" class="loginForm">
                              <label class="alert alert-success" role="alert">Message: Check your email indox or spam for the verification code</label>
                              <div class="form-floating mb-1">
                                   <input name="otp" type="number" class="form-control" min="6"  id="floatingInput" placeholder="name@example.com" required />
                                   <label for="floatingInput">Email Verification Code</label>
                              </div>
                              <label class="ms-2">Did you recieve the code? </label> <a href="recover.php">Resend Code</a>
                              <input name="verify" type="submit" class="btn form-control submitBtn mt-4 mb-1" value="VERIFY"/>
                         </form>
