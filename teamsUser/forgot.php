...
<html>
  ...
  <head>
    ...
    <title>Thesis Archiving System | Forgot Password</title>
    <meta charset="utf-8">
  ...
  <body style="background-color:#E5E5E5;">
    ...
    <div class="container-fluid row userform">
      ...
      <div style="padding: 50px; background-color:#F8FAFF;" class="col-md-6">
        ...
        <h3 style="font-weight: 700; margin-top: 20%;">Recover Password</h3>
        <div class="form-outline">
          <form action="forgot.php" method="post">
            ...
            <input name="user_forgot" type="submit" value="Send OTP" style="margin-top:20px; font-size:9pt; padding:10px; width:100%; background-color: #7788F4; border-color: #7788F4;" class="btn btn-primary">
