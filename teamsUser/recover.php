                    ...
                    <div class="col">
                         ...
                         <form  action="recover.php" method="post" class="loginForm">
                              ...
                              <div class="form-floating mb-3">
                                   <input name="userEmail" type="email" class="form-control" id="floatingInput" placeholder="name@example.com" required />
                                   <label for="floatingInput">Email address</label>
                              </div>
                              <input name="recover" type="submit" class="btn form-control submitBtn mb-1" value="RECOVER"/>
                         </form>
