...
<!-- This code is prepared by Jeffrix Briol -->
    ...
    <head>
        ...
        <title>Administration | Returned Records</title>
        <meta charset="utf-8">
    ...
    <body>
        ...
        <section class="home-section">
            <div class="text" style="font-size:43px; font-weight:600; line-height:64px; font-family:'Poppins'; color:#7788F4;"><p class="title">Returned Books</p></div>
                ...
                <table style="width:100%; border-collapse:collapse; margin:25px 0; font-size:0.9em; border-radius:5px 5px 0 0;min-width: 1000px;">
                    ...
                    <tbody>
                        <?php
                            ...
                            $dataQuery = "SELECT *, DATE_FORMAT(borrowStamp, '%M %d, %Y') as borrowDate, DATE_FORMAT(borrowDateReturn, '%M %d, %Y') as returnDate
                             FROM thesisborrow 
                                ...
                                WHERE borrowRemark='returned' OR borrowRemark='resolved late'
                        ...
                        <tr style="border-bottom:2px solid whitesmoke;">
                            <td><?php echo $row['borrowRequestId']; ?></td>
