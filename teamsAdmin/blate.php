...
<!-- This code is prepared by Jeffrix Briol -->
    ...
    <head>
        ...
        <title>Administration | Late Returned Records</title>
        <meta charset="utf-8">
    ...
    <body>
        ...
        <section class="home-section">
            <div class="text" style="font-size:43px; font-weight:600; line-height:64px; font-family:'Poppins'; color:#7788F4;"><p class="title">Late Returnees</p></div>
