...
<!-- This code is prepared by Jeffrix Briol -->
    ...
    <body style="background-color:#F8FAFF;">
        ...
        <!-- main container -->
        <!-- <div class="container-fluid row cont" style="background-color:#F8FAFF; width:60%; margin-top:5%; margin-bottom:5%; margin-left:auto; margin-right:auto; box-shadow:0px 1px 9px -1px rgba(0, 0, 0, 0.25); border-radius:3px; padding:0px;"> -->

            <!-- left side -->
            <!-- <div style="padding:50px;" class="col-md-6 conts"> -->
                <div class="container-fluid pt-5" style="margin-top: 50px;">
                    <div class="row align-items-center p-5 loginRow">
                        <div class="col" style="box-shadow: rgba(50, 50, 93, 0.25) 0px 6px 12px -2px, rgba(0, 0, 0, 0.3) 0px 3px 7px -3px; padding: 30px; border-radius: 5px;">
                            ...
                            <h2 style="font-family: 'Poppins';">ADMIN LOGIN</h2>
                            <div class="form-floating mb-3">
                              ...
                              <br>
                                ...
                                <input style="" name="adminLogin" type="submit" value="Log In" class="btn btnLogin"/>
                            </form>
                ...
                <h3 style="font-weight:600; font-size:32px; line-height:48px; margin-top:20%;">Admin Log in</h3> -->
            ...
            <!-- right side -->
            <!-- <div style="padding:5%; background-color:rgba(119, 136, 244, 0.21);" class="col-md-6 half">
                <img style="margin-top: 45%;" class="img-fluid  loginPic" src="../teamsResources/poster_2.png"/>
            </div> -->
        <!-- </div> -->
