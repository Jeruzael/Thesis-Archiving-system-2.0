               ...
               <div class="row align-items-center p-5 loginRow">
                    <div class="col">
                         ...
                         <form  action="changepass.php" method="post" class="loginForm">
                              <label class="alert alert-info" role="alert">Note: Please Remember your new Admin Password</label>
                              ...
                              <input name="adminchangepass" type="submit" class="btn form-control submitBtn" value="CHANGE AND LOGIN"/>
                         </form>
                    </div>
               </div>
          </div>
